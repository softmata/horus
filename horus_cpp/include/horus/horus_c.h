...
/* The two counters are how a C caller learns a message was lost: the      */
/* transport is overwrite-oldest, so _recv succeeding says nothing about   */
/* what it skipped to get there.                                           */
/* Sensor */
