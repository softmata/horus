...
/* on the subscriber: _new, _destroy, _recv, _has_msg, _missed_count.           */
/* The two counters are how a consumer of this ABI observes loss — a topic is   */
/* lossy by design, so a caller that never reads them cannot tell a quiet       */
/* sensor from a dead one.                                                      */
/* Sensor */
