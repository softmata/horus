...
- Use the dashboard to monitor your robot
...
HORUS includes a real-time monitoring dashboard.
...
See [Built-in Nodes](/built-in-nodes) for complete documentation.
...
Yes. HORUS supports network communication between robots. See [Network Communication](/core-concepts/network-communication).
...
- [Nodes](/core-concepts/core-concepts-nodes) - Node architecture and patterns
- [Hub and Topics](/core-concepts/core-concepts-hub) - Message passing system
- [Scheduler](/core-concepts/core-concepts-scheduler) - Execution control

### Practical Guides

- [Using Pre-Built Nodes](/package-management/using-prebuilt-nodes) - Leverage existing nodes
- [Built-in Nodes](/built-in-nodes) - Hardware drivers and sensors
- [Dashboard](/development/dashboard) - Monitoring and debugging

### Advanced Topics

- [Network Communication](/core-concepts/network-communication) - Multi-robot systems
- [Performance](/performance/performance) - Optimization techniques
- [Python Bindings](/multi-language/python-bindings) - Complete Python API reference
