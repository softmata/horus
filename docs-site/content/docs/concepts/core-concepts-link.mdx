...
Link is HORUS's ultra-low latency **Single Producer Single Consumer (SPSC)** communication system. It enables two nodes to exchange messages through shared memory with **248ns round-trip latency** - 1.94x faster than Hub.
...
**Ultra-Low Latency**: 248ns round-trip (vs 481ns for Hub) - the fastest IPC primitive in HORUS
...
- **248ns latency**: 1.94x faster than Hub
