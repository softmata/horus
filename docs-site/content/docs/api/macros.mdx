...
- [node! Macro Guide](/core-concepts/node-macro) - Detailed tutorial
- [message! Macro Guide](/core-concepts/message-macro) - Custom messages
- [horus_core API](/api/core) - Core types reference
