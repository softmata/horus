...
```toml
[dependencies]
horus_library = { version = "0.1.5", features = ["opencv-backend"] }
```
...
- **[Message Types](/core-concepts/message-types)** - Define custom AI result types
- **[Examples](/basic-examples)** - See complete vision projects
