...
**Core Concepts:**
- **[Nodes](/core-concepts/core-concepts-nodes)** - Deep dive into the Node pattern
- **[Hub](/core-concepts/core-concepts-hub)** - How ultra-fast communication works
- **[Scheduler](/core-concepts/core-concepts-scheduler)** - Priority-based execution

**Make Development Easier:**
- **[node! Macro](/core-concepts/node-macro)** - Eliminate boilerplate code
- **[CLI Reference](/development/cli-reference)** - All the `horus` commands
- **[Dashboard](/development/dashboard)** - Monitor your application visually

**See More Examples:**
- **[Examples](/basic-examples)** - Real applications you can run
- **[Multi-Language](/multi-language/multi-language)** - Use Python instead
...
1. **[Use the node! macro](/core-concepts/node-macro)** to eliminate boilerplate
2. **[Run the examples](/basic-examples)** to see real applications
3. **[Open the dashboard](/development/dashboard)** to monitor your system
