...
- Hardware is not yet supported (then publish to marketplace!)
...
1. **Create your own node** - Follow the [Node Macro](/core-concepts/node-macro) guide to create your own node that wraps any hardware driver with the same plug-and-play experience
