...
- Learn about [Hub](/core-concepts/core-concepts-hub) for pub/sub communication
- Explore [node! Macro](/core-concepts/node-macro) to eliminate node boilerplate too
