...
See **[Message Types: Typed vs Generic](/core-concepts/message-types#typed-messages-vs-generic-messages)** for detailed comparison.
...
- Apply these optimizations to your [Examples](/basic-examples)
- Learn about [Multi-Language Support](/multi-language/multi-language)
- Read the [Core Concepts](/core-concepts/core-concepts-nodes) for deeper understanding
