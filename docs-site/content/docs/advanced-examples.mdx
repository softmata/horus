...
**Prerequisites**: Complete [Basic Examples](/basic-examples) first.
...
```rust
use horus::prelude::*;
use horus_library::messages::{CmdVel, BatteryState};
...
- [Python Bindings Reference](/multi-language/python-bindings) - Complete Python API
...
- [Dashboard](/development/dashboard) - Monitor your system in real-time
