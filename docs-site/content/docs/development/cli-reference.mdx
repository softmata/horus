...
horus dashboard --reset-password
```
...
See [Dashboard Guide](/development/dashboard) for detailed features.
...
2. **[node! Macro](/core-concepts/node-macro)** - Write less code
3. **[Dashboard Guide](/development/dashboard)** - Master monitoring
4. **[Examples](/basic-examples)** - See real applications
