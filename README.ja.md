...
Python：`pip install "horus-robotics>=0.5.0"`。PyPI の最新版は 0.1.9 で、0.4.x の CLI とは共有メモリの形式が異なります。0.4.x が公開されるまでは、キャッシュされたソースからビルドしてください：`pip install ~/.horus/cache/horus@0.5.0/horus_py`。
