...
/// PWM command for DC motor control
///
/// Attributes:
///     channel_id: Motor channel (0-15)
///     duty_cycle: PWM duty cycle (-1.0 to 1.0, negative = reverse)
///     frequency: PWM frequency in Hz
///     enable: Enable motor driver output (bool)
///     brake_mode: Brake when disabled (bool)
///     current_limit: Current limit in amperes
///     timestamp_ns: Timestamp in nanoseconds
#[pyclass(name = "PwmCommand")]
#[derive(Clone)]
pub struct PyPwmCommand {
    pub(crate) inner: PwmCommand,
}
...
impl PyPwmCommand {
    ...
    #[setter]
    fn set_channel_id(&mut self, v: u8) {
        self.inner.channel_id = v;
    }
    #[getter]
    ...
    #[setter]
    fn set_duty_cycle(&mut self, v: f32) {
        self.inner.duty_cycle = v.clamp(-1.0, 1.0);
    }
    #[getter]
    ...
    #[setter]
    fn set_frequency(&mut self, v: u32) {
        self.inner.frequency = v;
    }
    #[getter]
    fn enable(&self) -> bool {
        self.inner.enable != 0
    ...
    #[getter]
    fn brake_mode(&self) -> bool {
        self.inner.brake_mode != 0
    }
    #[setter]
    fn set_brake_mode(&mut self, v: bool) {
        self.inner.brake_mode = v as u8;
    }
    #[getter]
    ...
    #[setter]
    fn set_current_limit(&mut self, v: f32) {
        self.inner.current_limit = v;
    }
    #[getter]
    fn timestamp_ns(&self) -> u64 {
        self.inner.timestamp_ns
    ...
    fn __repr__(&self) -> String {
        format!(
            "PwmCommand(ch={}, duty={:.1}%, freq={}Hz, enable={}, timestamp_ns={})",
            self.inner.channel_id,
...
/// Attributes:
///     motor_id: Motor ID (u8)
///     mode: Control mode (0=steps, 1=position, 2=velocity, 3=homing)
///     target: Target value
///     max_velocity: Maximum velocity in steps/sec
///     acceleration: Acceleration in steps/sec²
///     enable: Enable motor (bool)
///     microsteps: Microstepping mode (1-256)
///     current_limit: Current limit in milliamps
///     timestamp_ns: Timestamp in nanoseconds
#[pyclass(name = "StepperCommand")]
#[derive(Clone)]
pub struct PyStepperCommand {
    pub(crate) inner: StepperCommand,
}
...
impl PyStepperCommand {
    ...
    #[setter]
    fn set_microsteps(&mut self, v: u16) {
        self.inner.microsteps = v;
    }
    #[getter]
    fn current_limit(&self) -> u16 {
        self.inner.current_limit
    }
    #[setter]
    fn set_current_limit(&mut self, v: u16) {
        self.inner.current_limit = v;
    }
    #[getter]
    fn timestamp_ns(&self) -> u64 {
    ...
    fn __repr__(&self) -> String {
        format!(
            "StepperCommand(id={}, mode={}, target={:.2}, enable={}, timestamp_ns={})",
            self.inner.motor_id,
            self.inner.mode,
            self.inner.target,
            self.inner.enable != 0,
...
// ============================================================================
// TensorData — ML tensor
// ============================================================================

#[pyclass(name = "TensorData")]
#[derive(Clone)]
pub struct PyTensorData {
    pub(crate) inner: TensorData,
}
...
impl PyTensorData {
    ...
    fn new(data: Vec<f32>, shape: Vec<usize>, dtype: &str) -> PyResult<Self> {
        let dt = horus_core::types::TensorDtype::parse(dtype).ok_or_else(|| {
            pyo3::exceptions::PyValueError::new_err(format!("Unknown dtype: {}", dtype))
        })?;
        Ok(Self {
            inner: TensorData::new(data, shape, dt),
        })
    }
    #[getter]
    ...
    #[setter]
    fn set_dtype(&mut self, dtype: &str) -> PyResult<()> {
        self.inner.dtype = horus_core::types::TensorDtype::parse(dtype).ok_or_else(|| {
            pyo3::exceptions::PyValueError::new_err(format!("Unknown dtype: {}", dtype))
        })?;
        Ok(())
    }
    ...
    fn __repr__(&self) -> String {
        format!(
            "TensorData(shape={:?}, dtype={}, {} elements)",
            self.inner.shape,
            self.inner.dtype,
            self.inner.size()
        )
...
pub struct PyPredictions {
    pub(crate) inner: Predictions,
}

#[pymethods]
impl PyPredictions {
    #[new]
    #[pyo3(signature = (class_ids=vec![], scores=vec![], class_names=None))]
    fn new(class_ids: Vec<u32>, scores: Vec<f32>, class_names: Option<Vec<String>>) -> Self {
        Self {
            inner: Predictions {
                class_ids,
                scores,
    ...
    fn class_ids(&self) -> Vec<u32> {
        self.inner.class_ids.clone()
    }
    #[setter]
    fn set_class_ids(&mut self, ids: Vec<u32>) {
        self.inner.class_ids = ids;
    }
    #[getter]
    ...
    #[setter]
    fn set_scores(&mut self, scores: Vec<f32>) {
        self.inner.scores = scores;
    }
    #[getter]
    fn class_names(&self) -> Option<Vec<String>> {
        self.inner.class_names.clone()
    }
    #[setter]
    fn set_class_names(&mut self, names: Option<Vec<String>>) {
        self.inner.class_names = names;
    }
    #[getter]
    ...
    fn __repr__(&self) -> String {
        format!("Predictions({} classes)", self.inner.class_ids.len())
    }
}

// ============================================================================
// InferenceMetrics — ML inference timing
// ============================================================================

#[pyclass(name = "InferenceMetrics")]
#[derive(Clone)]
pub struct PyInferenceMetrics {
    pub(crate) inner: InferenceMetrics,
}

#[pymethods]
impl PyInferenceMetrics {
    #[new]
    #[pyo3(signature = (model_name="", latency_ms=0.0, throughput=0.0, batch_size=1, timestamp_ns=0))]
    fn new(
        model_name: &str,
        latency_ms: f32,
        throughput: f32,
    ...
    #[setter]
    fn set_latency_ms(&mut self, v: f32) {
    ...
    #[setter]
    fn set_throughput(&mut self, v: f32) {
        self.inner.throughput = v;
    }
    #[getter]
    ...
    fn __repr__(&self) -> String {
        format!(
            ...
            self.inner.model_name, self.inner.latency_ms, self.inner.throughput
        )
    }
}
...
impl PyModelInfo {
    #[new]
    #[pyo3(signature = (name="", version="0.1.0", format="onnx"))]
    fn new(name: &str, version: &str, format: &str) -> PyResult<Self> {
        Ok(Self {
            inner: ModelInfo {
                name: name.to_string(),
                version: version.to_string(),
                format: str_to_model_format(format)?,
                input_shapes: vec![],
                output_shapes: vec![],
                input_names: vec![],
                output_names: vec![],
    ...
    #[getter]
    fn format(&self) -> &str {
        model_format_to_str(self.inner.format)
    }
    #[setter]
    fn set_format(&mut self, v: &str) -> PyResult<()> {
        self.inner.format = str_to_model_format(v)?;
        Ok(())
    }
    #[getter]
    fn input_shapes(&self) -> Vec<Vec<usize>> {
        self.inner.input_shapes.clone()
    }
    #[setter]
    fn set_input_shapes(&mut self, v: Vec<Vec<usize>>) {
        self.inner.input_shapes = v;
    }
    #[getter]
    fn output_shapes(&self) -> Vec<Vec<usize>> {
        self.inner.output_shapes.clone()
    }
    #[setter]
    fn set_output_shapes(&mut self, v: Vec<Vec<usize>>) {
        self.inner.output_shapes = v;
    }
    #[getter]
    fn input_names(&self) -> Vec<String> {
        self.inner.input_names.clone()
    }
    #[setter]
    fn set_input_names(&mut self, v: Vec<String>) {
        self.inner.input_names = v;
    }
    #[getter]
    ...
    #[setter]
    fn set_output_names(&mut self, v: Vec<String>) {
        self.inner.output_names = v;
    }
    #[getter]
    fn metadata(&self) -> std::collections::HashMap<String, String> {
        self.inner.metadata.clone()
...
// ============================================================================
// FeatureVector — ML embeddings
// ============================================================================

#[pyclass(name = "FeatureVector")]
#[derive(Clone)]
pub struct PyFeatureVector {
    pub(crate) inner: FeatureVector,
}

#[pymethods]
impl PyFeatureVector {
    #[new]
    #[pyo3(signature = (features=vec![], source=None, timestamp_ns=0))]
    fn new(features: Vec<f32>, source: Option<String>, timestamp_ns: u64) -> Self {
        Self {
            inner: FeatureVector {
                features,
                source,
    ...
    #[setter]
    fn set_features(&mut self, v: Vec<f32>) {
    ...
    #[setter]
    fn set_source(&mut self, v: Option<String>) {
        self.inner.source = v;
    }
    #[getter]
    fn timestamp_ns(&self) -> u64 {
    ...
    fn __repr__(&self) -> String {
        format!("FeatureVector(dim={})", self.inner.features.len())
    }
}
...
pub struct PyClassification {
    pub(crate) inner: Classification,
}

#[pymethods]
impl PyClassification {
    #[new]
    #[pyo3(signature = (class_ids=vec![], class_names=vec![], probabilities=vec![], timestamp_ns=0))]
    fn new(
        class_ids: Vec<u32>,
    ...
    #[setter]
    fn set_class_ids(&mut self, v: Vec<u32>) {
        self.inner.class_ids = v;
    }
    #[getter]
    ...
    #[setter]
    fn set_class_names(&mut self, v: Vec<String>) {
        self.inner.class_names = v;
    }
    #[getter]
    fn probabilities(&self) -> Vec<f32> {
        self.inner.probabilities.clone()
    }
    #[setter]
    fn set_probabilities(&mut self, v: Vec<f32>) {
        self.inner.probabilities = v;
    }
    #[getter]
    fn timestamp_ns(&self) -> u64 {
        self.inner.timestamp_ns
    ...
    fn __repr__(&self) -> String {
        format!("Classification({} classes)", self.inner.class_ids.len())
    }
}
...
pub struct PyTrainingMetrics {
    pub(crate) inner: TrainingMetrics,
}

#[pymethods]
impl PyTrainingMetrics {
    #[new]
    #[pyo3(signature = (epoch=0, step=0, loss=0.0, accuracy=None, learning_rate=0.001, timestamp_ns=0))]
    fn new(
        epoch: u32,
        step: u32,
        loss: f32,
    ...
    #[setter]
    fn set_accuracy(&mut self, v: Option<f32>) {
        self.inner.accuracy = v;
    }
    #[getter]
    ...
    #[setter]
    fn set_learning_rate(&mut self, v: f32) {
        self.inner.learning_rate = v;
    }
    #[getter]
    fn timestamp_ns(&self) -> u64 {
        self.inner.timestamp_ns
    ...
    fn __repr__(&self) -> String {
        format!(
            "TrainingMetrics(epoch={}, step={}, loss={:.4})",
            self.inner.epoch, self.inner.step, self.inner.loss
        )
    }
}

// ============================================================================
// MlTrajectoryPoint — Imitation learning data point
// ============================================================================

#[pyclass(name = "MlTrajectoryPoint")]
#[derive(Clone)]
pub struct PyMlTrajectoryPoint {
    pub(crate) inner: MlTrajectoryPoint,
}

#[pymethods]
impl PyMlTrajectoryPoint {
    #[new]
    #[pyo3(signature = (observation, action, reward=None, done=false, timestamp_ns=0))]
    fn new(
        observation: PyTensorData,
        action: PyTensorData,
        reward: Option<f32>,
        done: bool,
        timestamp_ns: u64,
        ...
        Self {
            inner: MlTrajectoryPoint {
                observation: observation.inner,
                action: action.inner,
                reward,
                done,
                timestamp_ns,
    ...
    #[getter]
    fn observation(&self) -> PyTensorData {
        PyTensorData {
            inner: self.inner.observation.clone(),
        }
    }
    #[setter]
    fn set_observation(&mut self, v: PyTensorData) {
        self.inner.observation = v.inner;
    }
    #[getter]
    fn action(&self) -> PyTensorData {
        PyTensorData {
            inner: self.inner.action.clone(),
        }
    }
    #[setter]
    fn set_action(&mut self, v: PyTensorData) {
        self.inner.action = v.inner;
    }
    #[getter]
    ...
    #[setter]
    fn set_reward(&mut self, v: Option<f32>) {
        self.inner.reward = v;
    }
    #[getter]
    fn done(&self) -> bool {
    ...
    fn __repr__(&self) -> String {
        format!(
            "MlTrajectoryPoint(obs={:?}, act={:?}, done={})",
            self.inner.observation.shape, self.inner.action.shape, self.inner.done
        )
    }
}

// ============================================================================
// DeploymentConfig — ML model deployment
// ============================================================================

#[pyclass(name = "DeploymentConfig")]
#[derive(Clone)]
pub struct PyDeploymentConfig {
    pub(crate) inner: DeploymentConfig,
}

#[pymethods]
impl PyDeploymentConfig {
    #[new]
    #[pyo3(signature = (model_path="", format="onnx", execution_provider="cpu", batch_size=1, use_fp16=false, num_threads=None, device_id=None))]
    fn new(
        model_path: &str,
        format: &str,
    ...
    #[setter]
    fn set_model_path(&mut self, v: String) {
        self.inner.model_path = v;
    }
    #[getter]
    fn format(&self) -> &str {
        model_format_to_str(self.inner.format)
    ...
    #[setter]
    fn set_execution_provider(&mut self, v: String) {
        self.inner.execution_provider = v;
    }
    #[getter]
    fn batch_size(&self) -> usize {
        self.inner.batch_size
    ...
    #[getter]
    fn use_fp16(&self) -> bool {
        self.inner.use_fp16
    }
    #[setter]
    fn set_use_fp16(&mut self, v: bool) {
        self.inner.use_fp16 = v;
    }
    #[getter]
    ...
    #[setter]
    fn set_num_threads(&mut self, v: Option<usize>) {
        self.inner.num_threads = v;
    }
    #[getter]
    ...
    #[setter]
    fn set_device_id(&mut self, v: Option<u32>) {
        self.inner.device_id = v;
    }
    #[classattr]
    fn __topic_name__() -> &'static str {
        "deployment_config"
...
// ============================================================================
// TactileArray — Tactile sensor array (Pod)
// ============================================================================
...
impl PyTactileArray {
    #[new]
    #[pyo3(signature = (sensor_count=0, arrangement=0, grid_width=8, grid_height=8))]
    fn new(sensor_count: u8, arrangement: u8, grid_width: u8, grid_height: u8) -> Self {
        Self {
            inner: TactileArray {
                sensor_count,
                arrangement,
                grid_width,
                grid_height,
                ..TactileArray::default()
            },
        }
    }
    #[getter]
    fn sensors(&self) -> Vec<f32> {
        self.inner.sensors.to_vec()
    }
    #[getter]
    ...
    #[setter]
    fn set_sensor_count(&mut self, v: u8) {
        self.inner.sensor_count = v;
    }
    #[getter]
    ...
    #[setter]
    fn set_arrangement(&mut self, v: u8) {
        self.inner.arrangement = v;
    }
    #[getter]
    ...
    #[setter]
    fn set_sensor_spacing(&mut self, v: f32) {
        self.inner.sensor_spacing = v;
    }
    #[getter]
    ...
    #[setter]
    fn set_sensitivity(&mut self, v: f32) {
        self.inner.sensitivity = v;
    }
    #[getter]
    fn timestamp_ns(&self) -> u64 {
        self.inner.timestamp_ns
    ...
    fn set_sensor(&mut self, index: usize, value: f32) -> PyResult<()> {
        if index < 64 {
            self.inner.sensors[index] = value;
            Ok(())
        } else {
            Err(pyo3::exceptions::PyIndexError::new_err(
                "sensor index out of range (0..63)",
            ))
        }
    }
    fn get_sensor(&self, index: usize) -> PyResult<f32> {
        if index < 64 {
            Ok(self.inner.sensors[index])
        } else {
            Err(pyo3::exceptions::PyIndexError::new_err(
                "sensor index out of range (0..63)",
            ))
    ...
    fn __repr__(&self) -> String {
        format!(
            "TactileArray({} sensors, {}x{})",
            self.inner.sensor_count, self.inner.grid_width, self.inner.grid_height
        )
    }
}
...
pub fn register_message_classes(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_class::<PyInferenceMetrics>()?;
