//! Atomic operations codegen inspection
//!
//! This file contains isolated atomic operations to verify optimal codegen.
//! Build with: RUSTFLAGS="-C target-cpu=native" cargo build --release --example atomic_codegen
//! View assembly with: cargo asm --lib -p horus_core --example atomic_codegen <function_name>
