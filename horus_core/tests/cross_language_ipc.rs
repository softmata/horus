...
//! with and without clearing `/dev/shm` between runs. The claim does not
...
//! received 0" is exactly that shape — no partial delivery, which a genuine
//! timing race would produce.
//!
