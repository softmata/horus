...
use crate::types::{CostMapDescriptor, Device, TensorDtype};
...
impl CostMap {
    ...
    pub fn new(
        ...
        let grid_tensor = pool.alloc(&shape, TensorDtype::I8, Device::cpu())?;
        let cost_tensor = pool.alloc(&shape, TensorDtype::U8, Device::cpu())?;
