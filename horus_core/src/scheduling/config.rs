...
pub struct RealTimeConfig {
    ...
    /// Fail on high-severity RT degradation (set by require_rt()).
    /// When false (default/prefer_rt), degradations are logged but execution continues.
    pub require_mode: bool,
}
