...
{
    // Input subscribers
    encoder_left_sub: Topic<i64>,
    encoder_right_sub: Topic<i64>,
    velocity_sub: Topic<Twist>,
...
impl OdometryNode {
    ...
    pub fn new_differential_drive(wheel_base: f64, wheel_radius: f64) -> Result<Self> {
        Ok(Self {
            encoder_left_sub: Topic::new("encoder.left")?,
            encoder_right_sub: Topic::new("encoder.right")?,
            velocity_sub: Topic::new("cmd_vel")?,
            odom_publisher: Topic::new("odom")?,
