...
{
    publisher: Topic<SafetyStatus>,
    emergency_subscriber: Topic<EmergencyStop>,
    battery_subscriber: Topic<BatteryState>,
    resource_subscriber: Topic<ResourceUsage>,
...
impl SafetyMonitorNode {
    ...
    pub fn new_with_topic(topic: &str) -> Result<Self> {
        ...
        Ok(Self {
            ...
            emergency_subscriber: Topic::new("emergency_stop")?,
            battery_subscriber: Topic::new("battery_state")?,
            resource_subscriber: Topic::new("resource_usage")?,
