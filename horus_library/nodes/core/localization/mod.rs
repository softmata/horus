...
{
    pose_publisher: Topic<Odometry>,
    odometry_subscriber: Topic<Odometry>,
    imu_subscriber: Topic<Imu>,
...
impl LocalizationNode {
    ...
    pub fn new_with_topics(
        ...
        Ok(Self {
            pose_publisher: Topic::new(pose_topic)?,
            odometry_subscriber: Topic::new(odom_topic)?,
            imu_subscriber: Topic::new(imu_topic)?,
    ...
    P: Processor<Odometry>,
{
    ...
    pub fn build(self) -> Result<LocalizationNode<P>> {
        ...
        Ok(LocalizationNode {
            pose_publisher: Topic::new(&self.pose_topic)?,
            odometry_subscriber: Topic::new(&self.odom_topic)?,
            imu_subscriber: Topic::new(&self.imu_topic)?,
