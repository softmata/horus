...
// Geometry
#[test] fn roundtrip_accel() { json_roundtrip(&Accel::default(), "Accel"); }
#[test] fn roundtrip_accel_stamped() { json_roundtrip(&AccelStamped::default(), "AccelStamped"); }
#[test] fn roundtrip_pose_stamped() { json_roundtrip(&PoseStamped::default(), "PoseStamped"); }
#[test] fn roundtrip_pose_with_covariance() { json_roundtrip(&PoseWithCovariance::default(), "PoseWithCovariance"); }
#[test] fn roundtrip_twist_with_covariance() { json_roundtrip(&TwistWithCovariance::default(), "TwistWithCovariance"); }

// Control
#[test] fn roundtrip_servo_command() { json_roundtrip(&ServoCommand::default(), "ServoCommand"); }
#[test] fn roundtrip_differential_drive() { json_roundtrip(&DifferentialDriveCommand::default(), "DifferentialDriveCommand"); }
#[test] fn roundtrip_pid_config() { json_roundtrip(&PidConfig::default(), "PidConfig"); }
#[test] fn roundtrip_trajectory_point() { json_roundtrip(&TrajectoryPoint::default(), "TrajectoryPoint"); }
#[test] fn roundtrip_joint_command() { json_roundtrip(&JointCommand::default(), "JointCommand"); }

// Diagnostics
#[test] fn roundtrip_resource_usage() { json_roundtrip(&ResourceUsage::default(), "ResourceUsage"); }
#[test] fn roundtrip_diagnostic_value() { json_roundtrip(&DiagnosticValue::default(), "DiagnosticValue"); }
#[test] fn roundtrip_diagnostic_report() { json_roundtrip(&DiagnosticReport::default(), "DiagnosticReport"); }
#[test] fn roundtrip_node_heartbeat() { json_roundtrip(&NodeHeartbeat::default(), "NodeHeartbeat"); }
#[test] fn roundtrip_safety_status() { json_roundtrip(&SafetyStatus::default(), "SafetyStatus"); }

// Navigation
#[test] fn roundtrip_nav_goal() { json_roundtrip(&NavGoal::default(), "NavGoal"); }

// Clock
#[test] fn roundtrip_clock() { json_roundtrip(&Clock::default(), "Clock"); }
#[test] fn roundtrip_time_reference() { json_roundtrip(&TimeReference::default(), "TimeReference"); }

// Detection / Perception
#[test] fn roundtrip_bounding_box_3d() { json_roundtrip(&BoundingBox3D::default(), "BoundingBox3D"); }
#[test] fn roundtrip_detection_3d() { json_roundtrip(&Detection3D::default(), "Detection3D"); }
#[test] fn roundtrip_tracked_object() { json_roundtrip(&TrackedObject::default(), "TrackedObject"); }
#[test] fn roundtrip_tracking_header() { json_roundtrip(&TrackingHeader::default(), "TrackingHeader"); }
#[test] fn roundtrip_landmark() { json_roundtrip(&Landmark::default(), "Landmark"); }
#[test] fn roundtrip_landmark_3d() { json_roundtrip(&Landmark3D::default(), "Landmark3D"); }
#[test] fn roundtrip_segmentation_mask() { json_roundtrip(&SegmentationMask::default(), "SegmentationMask"); }
#[test] fn roundtrip_plane_detection() { json_roundtrip(&PlaneDetection::default(), "PlaneDetection"); }

// Vision
#[test] fn roundtrip_region_of_interest() { json_roundtrip(&RegionOfInterest::default(), "RegionOfInterest"); }

// Force / Torque
#[test] fn roundtrip_wrench_stamped() { json_roundtrip(&WrenchStamped::default(), "WrenchStamped"); }
#[test] fn roundtrip_force_command() { json_roundtrip(&ForceCommand::default(), "ForceCommand"); }
#[test] fn roundtrip_impedance_parameters() { json_roundtrip(&ImpedanceParameters::default(), "ImpedanceParameters"); }
// ContactInfo and HapticFeedback not exported from messages::* — skip

// Input — use button constructor
#[test] fn roundtrip_joystick_input() {
    let joy = JoystickInput::new_button(0, 0, "A".to_string(), true);
    json_roundtrip(&joy, "JoystickInput");
}
#[test] fn roundtrip_keyboard_input() {
    let key = KeyboardInput::new("A".to_string(), 65, vec![], true);
    json_roundtrip(&key, "KeyboardInput");
}

// Audio
#[test] fn roundtrip_audio_frame() { json_roundtrip(&AudioFrame::default(), "AudioFrame"); }
