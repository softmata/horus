...
[![Version](https://img.shields.io/badge/v0.4.1-blue.svg)](https://github.com/softmata/horus/releases)
...
**Python**: `pip install "horus-robotics>=0.4.1"` — keep the floor. The newest
...
tree the installer already cached: `pip install ~/.horus/cache/horus@0.4.1/horus_py`.
...
| Variable                       | Effect                                                                          |
|--------------------------------|---------------------------------------------------------------------------------|
| `HORUS_VERSION=v0.4.1`         | install exactly that release — binary and source. Leading `v` optional          |
