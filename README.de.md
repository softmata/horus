...
Python: `pip install "horus-robotics>=0.4.1"`. Die neueste Version auf PyPI ist 0.1.9 und verwendet ein älteres Shared-Memory-Format als eine 0.4.x-CLI; solange 0.4.x dort nicht veröffentlicht ist, die Bindings aus dem Cache bauen: `pip install ~/.horus/cache/horus@0.4.1/horus_py`.
